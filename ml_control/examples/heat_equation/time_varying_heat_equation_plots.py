...
from ml_control.problem_definitions.heat_equation import create_time_varying_heat_equation_problem
from ml_control.visualization import plot_final_time_adjoints, plot_controls, plot_final_time_solutions, \
    animate_solution


full_model = create_time_varying_heat_equation_problem()
